...
var equipmentController_1 = __importDefault(require("./controllers/equipmentController"));
var localController_1 = __importDefault(require("./controllers/localController"));
var loginController_1 = __importDefault(require("./controllers/loginController"));
var osTypeController_1 = __importDefault(require("./controllers/osTypeController"));
var osStateController_1 = __importDefault(require("./controllers/osStateController"));
...
var statisticsController_1 = __importDefault(require("./controllers/statisticsController"));
var routes = express_1.default.Router();
var emailController = new emailController_1.default();
var equipmentController = new equipmentController_1.default();
var localController = new localController_1.default();
var loginController = new loginController_1.default();
var osTypeController = new osTypeController_1.default();
var osStateController = new osStateController_1.default();
var osController = new osController_1.default();
var sessionController = new sessionController_1.default();
var statisticsController = new statisticsController_1.default();
...
routes.get('/os-serial-number/:equipmentSerialNumber', osController.getOsBySerialNumber);
